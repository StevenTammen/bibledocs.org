---
title: "How can I trust the Bible? (src: Apologetics Canada)"
weight: 
contentlevel: intermediate
layout: aggregation-page
---

This discussion series is about the "How can I trust the Bible?" study from Apologetics Canada. The original study goes over reasons we have can have full confidence in the Bible as our source of truth, such as how it contains only genuine books (and not fakes), and how the text that has come down to us from antiquity is astoundingly free from problems, all things considered.

<!--more-->

<!-- aggregate-page-content -->

## [The right books (src: Apologetics Canada)](/discussion/apologetics-canada/shorter-topical-studies/how-can-i-trust-the-bible/the-right-books) {#the-right-books-src-apologetics-canada}



{{< discussion-note src="Apologetics Canada" text="Can I Trust the Bible - Episode 1: The Right Books" url="https://www.youtube.com/watch?v=QhVPBNBAGY0" >}}

### Video {#the-right-books-src-apologetics-canada-video}

- [Link to recording segments on Dropbox](https://www.dropbox.com/scl/fo/spgl3mgx2fttnk3vy8l6i/AKkoZ2kqZe3GnSvex3LaVd0?rlkey=121a3c7ul5k92na07m7kmbsb4&st=mgep0cgt&dl=0)

### Summary {#the-right-books-src-apologetics-canada-summary}
...
### Content {#the-right-books-src-apologetics-canada-content}

<!-- slide-break -->

#### Why is the Bible important? {#the-right-books-src-apologetics-canada-why-is-the-bible-important}
...
(0:54) I really have no reason to put my hope
(0:55) **and trust in Jesus**
(0:57) [Music]
...
##### Summary points and follow-on topics {#the-right-books-src-apologetics-canada-summary-points-and-follow-on-topics}
...
##### Further discussion {#the-right-books-src-apologetics-canada-further-discussion}

<!-- slide-break -->

#### Some basic facts about the Bible and its writings {#the-right-books-src-apologetics-canada-some-basic-facts-about-the-bible-and-its-writings}
...
(1:08) **hey Andy Steiger here**, what's up we are on
(1:10) our way to the airport heading to Egypt

End:

(2:17) a history going back to the words and
(2:20) **teachings of
(2:26) Jesus** so Wes why are we going to Egypt
(2:29) to talk about the Bible I think a lot of
...
#### Egypt, early manuscripts, and what it means for our understanding of the canon {#the-right-books-src-apologetics-canada-egypt-early-manuscripts-and-what-it-means-for-our-understanding-of-the-canon}
...
(5:52) Jesus spoke and which dimus Judas Thomas
(5:56) **wrote down**
(6:00) we're here in Egypt sailing on a Fuca on
(6:03) the Nile River and you know it wasn't
...
- Because of its dry climate and the fact that the papyrus plant commonly used for writing in antiquity grew almost exclusively in Egypt, Egypt is where many (but not all) of our earliest surviving biblical manuscripts come from.
  - For example, [Papyrus P52](https://en.wikipedia.org/wiki/Rylands_Library_Papyrus_P52), widely considered to be the earliest extant New Testament manuscript we have. Some good reading material on the earliest biblical manuscripts: [The Earliest New Testament Manuscripts – Bible Archaeology Report](https://biblearchaeologyreport.com/2019/02/15/the-earliest-new-testament-manuscripts/).
  - [Codex Sinaiticus](https://en.wikipedia.org/wiki/Codex_Sinaiticus), [Codex Vaticanus](https://en.wikipedia.org/wiki/Codex_Vaticanus), [Codex Alexandrinus](https://en.wikipedia.org/wiki/Codex_Alexandrinus), and [Codex Ephraemi Rescriptus](https://en.wikipedia.org/wiki/Codex_Ephraemi_Rescriptus)---the four so-called ["great uncial codices"](https://en.wikipedia.org/wiki/Great_uncial_codices)---all have somewhat foggy origins, so we can't necessarily trace them to Egypt. But many of the earliest more fragmentary biblical manuscripts we have are in fact Egyptian papyri.
...
- The specifics of dating manuscripts and tracing their origins and peculiarities is a fascinating scholarly endeavor. We are blessed to live when we do, when many of the most importance manuscripts have been completely digitized and made available to all. For example, Codex Sinaiticus is available [for free online](https://www.codexsinaiticus.org/en/manuscript.aspx).
...
#### Introduction to the concept of pseudepigrapha {#the-right-books-src-apologetics-canada-introduction-to-the-concept-of-pseudepigrapha}
...
(9:45) religious sects from **across the ancient
(9:51) world** we're here uh in the desert of
(9:53) Egypt uh not far from Al-Qasr and we
...
- The "motive" for later writers naming texts using the names of the Apostles:
  - Sort of the opposite pattern as plagiarism. Rather than taking your work and putting my name on it, I'm going to take my work and put your name on it. Why? Because it makes it easy to make an [appeal to authority](https://en.wikipedia.org/wiki/Argument_from_authority) argument.
...
#### What happened to the texts after their discovery? {#the-right-books-src-apologetics-canada-what-happened-to-the-texts-after-their-discovery}
...
(12:01) F I don't want to have anything to do
(12:03) with that **I'm telling you that right now**
(12:05) Wes when people ask me about these
(12:07) Gnostic Gospels like the Gospel of
...
(18:44) years the answer to that question can
(18:47) also be found **buried in the Sands of
(18:50) Egypt**
...
### Review Questions {#the-right-books-src-apologetics-canada-review-questions}
...
## [The right text (src: Apologetics Canada)](/discussion/apologetics-canada/shorter-topical-studies/how-can-i-trust-the-bible/the-right-text) {#the-right-text-src-apologetics-canada}



{{< discussion-note src="Apologetics Canada" text="Can I Trust the Bible - Episode 2: The Right Text" url="https://www.youtube.com/watch?v=KkmLCWeORaQ" >}}

### Video {#the-right-text-src-apologetics-canada-video}

- [Link to recording segments on Dropbox](https://www.dropbox.com/scl/fo/7gq7c5plby9tm35w7objh/AHG-n_jMmtxpQoaJKA6EYIw?rlkey=dr1gbdshdrczh6pc2cz3nrokn&st=5f8z85oc&dl=0)

### Summary {#the-right-text-src-apologetics-canada-summary}
...
### Content {#the-right-text-src-apologetics-canada-content}

<!-- slide-break -->

#### Introduction, and the discovery of the Oxyrhynchus papyri {#the-right-text-src-apologetics-canada-introduction-and-the-discovery-of-the-oxyrhynchus-papyri}
...
(0:58) Jesus **hey Andy Steiger here** here we are in
(1:00) Egypt working on a new project called

End:

(3:34) **classical and religious
(3:40) texts** I'm here at the University of
(3:43) Pennsylvania Museum and I'm looking at

-->

<!-- slide-break -->

##### Summary points and follow-on topics {#the-right-text-src-apologetics-canada-summary-points-and-follow-on-topics}
...
##### Further discussion {#the-right-text-src-apologetics-canada-further-discussion}

<!-- slide-break -->

#### Did these discoveries fundamentally change the way we view the text of the Bible? {#the-right-text-src-apologetics-canada-did-these-discoveries-fundamentally-change-the-way-we-view-the-text-of-the-bible}
...
(5:38) **Greek that we now call the
(5:45) Septuagint** we're here in Alexandria
(5:48) Egypt at the Library of Alexandria Not
...
- I think these sorts of exceptions maybe get skimmed over a bit quickly here in support of the main point (which is unequivocally true = that manuscript discoveries have mostly reinforced what we know to be the text of the Bible, rather than contradicting it everywhere). But what about those pesky places where in fact manuscript discoveries *have* challenged parts of the text? Did believers in the past really just not know?
  ...
  - For the hundreds of years before some of the best manuscripts came to light (manuscripts that enabled us to gain a new perspective on these textual matters), did people just have no way to know that these things weren't actually part of the Bible? We should not wave our hands and dismiss that question too fast, because it is a perfectly valid thing to ask. <!-- slide-break -->
- As I see it, it actually gets worse too. Sometimes, even if the text isn't an interpolation (as in the cases mentioned above), Bible translations really drop the ball in passages that are difficult to interpret. Take the verse James 4:5 (see: [different translations of this verse on BibleHub](https://biblehub.com/james/4-5.htm)). Many English translations badly contradict each other in the translation of this verse, and interpretation of it is all over the place. In my opinion, most of the early English versions (including the KJV) got the sense of this verse wrong in their translations because they do not translate in such as way as to make it clear that James is actually referencing Galatians 5:17 in this verse. (See [here](https://ichthys.com/mail-Spirit-that-dwelleth.htm) for more explanation).
...
- But if the Bible is the centerpiece of our entire Christian Epistemology... well, you see the problem, right?<!-- slide-break -->
...
- So the fact that many people throughout history lacked direct access to God's Word is a sad thing indeed. In many ways, this probably crippled their understanding of the truth. But God knew what they lacked. Is He so unjust as to condemn them for something out of their control? I do not believe so. That is not the character of the God that I believe in.<!-- slide-break -->
...
#### The Septuagint, and the long history of the Bible getting translated to be read {#the-right-text-src-apologetics-canada-the-septuagint-and-the-long-history-of-the-bible-getting-translated-to-be-read}
...
(8:06) copied and that what we have now is what
(8:09) **the original authors
(8:13) wrote** hey Andy here on the streets of
(8:15) Egypt first thing you need to know it's
...
- The Septuagint is an example of the Bible's rich literary tradition—of how believers have always translated the books of the Bible into new languages in order that they may be read by all.<!-- slide-break -->
...
#### What about when there *are* actual manuscript differences? {#the-right-text-src-apologetics-canada-what-about-when-there-are-actual-manuscript-differences}
...
(8:58) don't know no kfka
(9:04) **So one thing I've always appreciated**
(9:05) about the Bible is it's not trying to uh

End:

(14:26) in the history of the textual traditions
(14:29) **of the Bible**
(14:31) [Music]
...
- The same situation is true of the "long ending" of the gospel of Mark, the pericope of the adulteress around the beginning of John chapter 8, and in several other cases besides.<!-- slide-break -->
- It is impossible for us to know the real reasons why some of these interpolations ended up added.
  ...
  - But ultimately, we have no way to know for sure. It is also possible that someone really did intentionally add to the main text right from the get-go, rather than the interpolation arising from accidental errors/misunderstandings in copying.<!-- slide-break -->
...
(15:22) but we've uh we have had many here in
(15:25) Egypt **so Wes we have confidence that**
(15:28) what we have in our New Testament is

End:

(19:05) documents there are good reasons to 
(19:08) **believe that you can trust the Bible**
...
- This places Luke's account within a historical framework, and makes it clear he is not just making up a story, but pinpointing exactly where and when these events actually took place in history.<!-- slide-break -->
...
### Review Questions {#the-right-text-src-apologetics-canada-review-questions}
