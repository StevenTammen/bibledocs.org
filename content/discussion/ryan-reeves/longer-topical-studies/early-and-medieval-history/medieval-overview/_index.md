...
title: "Medieval overview (src: Ryan Reeves)"
stags: 
    - Middle Ages  
ptags: 
...
{{< discussion-note src="Ryan Reeves" text="Medieval Overview" url="https://www.youtube.com/watch?v=G4P_ls7G5tc" >}}

## Video {#video}

- [Link to recording segments on Dropbox](https://www.dropbox.com/scl/fo/ba16iplzd48g6jczafc1n/ACIEEgAG40hgA8Bw-sVpjAE?rlkey=011yidmly4xsraj0cjzyf4g6g&st=h4dtmian&dl=0)
...
srcyoutubevideoid="G4P_ls7G5tc"
srctitle="Medieval Overview"
srcstart="13"
srcend="562"
...
**In 16605 Miguel Cervantes** gave us really an enduring image of what the Middle
...
that they have some preconceptions on that they can then develop and shape but which then sort of **draws all this period out.** If we're going to look at the Middle Ages we have to understand what the period of time is though and so I want to give you just sort of three brackets
...
- The epic poem [*Beowulf*](https://en.wikipedia.org/wiki/Beowulf)
...
- The development of [Scholasticism](https://en.wikipedia.org/wiki/Scholasticism)
- The writings and views of [Thomas Aquinas](https://en.wikipedia.org/wiki/Thomas_Aquinas), [William of Occam](https://en.wikipedia.org/wiki/William_of_Ockham) (ever heard of "Occam's Razor"? It's from this guy), and other theologians who shaped the intellectual fabric of the Western World.
...
- People like [John Wycliffe](https://en.wikipedia.org/wiki/John_Wycliffe) and [Jan Hus](https://en.wikipedia.org/wiki/Jan_Hus)
...
##### Reflecting again upon how art can color our perspective of history and theology in problematic ways {#reflecting-again-upon-how-art-can-color-our-perspective-of-history-and-theology-in-problematic-ways}

{{< properties

stags="Art > Likely has no rigorus scholerly analysis behind it, making it a poor teacher of history | Art > Theology-focused art has the potential to negatively color our spiritual perception"
...
stags="Middle Ages > Are important in the development of Western Civilization | Middle Ages > Are not so dark and dreary, but rather are historically interesting"
...
happened in the high Middle Ages during the so-called pristine years and you can't pin those on the latter Middle Ages **at least not in full.** So if that is the sweep of the history of the time periods of the Middle Ages
...
- The development of [Scholasticism](https://en.wikipedia.org/wiki/Scholasticism) and other theological ideas in the West.
...
##### The utility of categorizing history into sections, with hindsight {#the-utility-of-categorizing-history-into-sections-with-hindsight}

{{< properties

stags=" History > Historical divisions are a useful tool in analysis"
...
stags="History > Historical conceptual frameworks can be formally tested through data | History > Historians update their theories as new evidence surfaces, much like scientists do"
...
Reformation which broke away from the medieval perspective **on faith Theology and the Bible.**
...
- The rise of [Charlemagne](https://en.wikipedia.org/wiki/Charlemagne) and the [Carolingian Empire](https://en.wikipedia.org/wiki/Carolingian_Empire), and the development of European political entities:
...
- The [Black Death](https://en.wikipedia.org/wiki/Black_Death) plague pandemic.
- War, famine, marriage and everything else you might experience as an individual living in these times.
- The rise of various kingdoms, and how they warred with another other (in, for example, the [Hundred Years' War](https://en.wikipedia.org/wiki/Hundred_Years%27_War)).
...
##### Trying to understand the Reformation without first understanding the Middle Ages will not work very well {#trying-to-understand-the-reformation-without-first-understanding-the-middle-ages-will-not-work-very-well}

{{< properties

stags="Middle Ages > The context of this time period helps us properly understand the Reformation | History > Removing events from context makes it much harder to trace lines of cause and effect"
...
# Which of the following statements about *Don Quixote* are true? {#which-of-the-following-statements-about-don-quixote-are-true}

I. Was published in 1605 by Miquel Cervantes. 
II. Helps fight against prevailing misconceptions about the Middle Ages. 
III. Is told from the perspective of a simple farmer. 
IV. Was published in three volumes. 
...
# True or False: Written sources from the Middle Ages are relatively few when compared to Classical Antiquity and the periods that follow. {#true-or-false-written-sources-from-the-middle-ages-are-relatively-few-when-compared-to-classical-antiquity-and-the-periods-that-follow}

1. [x] True
1. [ ] False

# True or False: Art can color our perspective of history and theology in problematic ways. {#true-or-false-art-can-color-our-perspective-of-history-and-theology-in-problematic-ways}

1. [x] True
1. [ ] False

# To help conceptualize the overall sweep of the times, the Middle Ages are typically broken down into how many separate periods? {#to-help-conceptualize-the-overall-sweep-of-the-times-the-middle-ages-are-typically-broken-down-into-how-many-separate-periods}

1. [x] Three
1. [ ] Four
1. [ ] Five

# The Early Middle Ages spanned what time period? {#the-early-middle-ages-spanned-what-time-period}

1. [ ] 1000-1300 
1. [x] 500-1000
1. [ ] 1300-1500

# The High Middle Ages spanned what time period? {#the-high-middle-ages-spanned-what-time-period}

1. [ ] 1300-1500
1. [x] 1000-1300 
1. [ ] 500-1000

# The Later Middle Ages spanned what time period? {#the-later-middle-ages-spanned-what-time-period}

1. [ ] 500-1000
1. [ ] 1000-1300 
1. [x] 1300-1500

# The Early Middle Ages are charaterized by historians with which of the following? {#the-early-middle-ages-are-charaterized-by-historians-with-which-of-the-following}

Check all that apply.

1. [x] Ongoing fallout from the destruction of the unified Roman Empire.
1. [ ] The flourishing of art and literature.
1. [x] A rising force of nationalistic sentiment.
1. [ ] A rise in visible church activity.
1. [ ] The Crusades 

# The High Middle Ages are charaterized by historians with which of the following? {#the-high-middle-ages-are-charaterized-by-historians-with-which-of-the-following}

Check all that apply.

1. [ ] Ongoing fallout from the destruction of the unified Roman Empire.
1. [x] The Crusades 
1. [ ] A rising force of nationalistic sentiment.
1. [x] A rise in visible church activity.
1. [x] The development of Scholasticism and other theological ideas in the West.

# Which of the following statements about the Later Middle Ages are true? {#which-of-the-following-statements-about-the-later-middle-ages-are-true}

Check all that apply. 

1. [x] This period has much ongoing scholarly debate in regards to its nature.
1. [ ] The Crusades occured during this period. 
1. [x] We cannot completely pin all the poor theology and poor thinking onto the Later period. 
1. [x] Luther and the reformers reacted against developments during Middle Ages as a whole, not just events of the Later Middle Ages. 
1. [ ] All of the above. 

# Which of the following statements are false? {#which-of-the-following-statements-are-false}

I. Historical conceptual frameworks are useful tools in analysis.
II. Historical scholarship can be tested and updated based upon new evidence and analysis. 
III. Categorizing periods of history based on shared characteristics help us understand the spread of people, technology, and ideas. 
...
# True or False: The developments of the Middle Ages are less important than Greco-Roman Antiquity as they relate to how Western Civilization came to be. {#true-or-false-the-developments-of-the-middle-ages-are-less-important-than-greco-roman-antiquity-as-they-relate-to-how-western-civilization-came-to-be}

1. [ ] True
1. [x] False

# True or False: To properly contextualize the Protestant Reformation, one needs to understand the medieval world and church of the Middle Ages. {#true-or-false-to-properly-contextualize-the-protestant-reformation-one-needs-to-understand-the-medieval-world-and-church-of-the-middle-ages}
