...
title: "Gnosticism and the Early Church (src: Ryan Reeves)"
stags: 
ptags: 
...
{{< discussion-note src="Ryan Reeves" text="Gnosticism and the Early Church" url="https://www.youtube.com/watch?v=GXc-vvCivp4" >}}

## Video {#video}

- [Link to recording segments on Dropbox](https://www.dropbox.com/scl/fo/0ilhw9t87buebx5rgergk/ACF9j2P2iZc0xk3_UCaYp7g?rlkey=oi4n27wr3mkza6oxnzb1m0cwq&st=9q6kxzjp&dl=0)
...
### Video intro, and a discussion of docetism {#video-intro-and-a-discussion-of-docetism}
...
(0:14) **in this lecture** we're going to be
(0:15) looking at gnosticism and the earliest

End:

(6:00) terms of its impact and its influence on
(6:02) **the early church** coming out of that same
(6:04) soup of ideas though there is the
...
- A simple definition of docetism would be the belief that Christ could not have had a human body
  ...
  - Or perhaps from an improper emphasis on Jesus's divinity, at the expense of His humanity.<!-- slide-break -->
...
### Introduction to gnosticism proper {#introduction-to-gnosticism-proper}
...
(14:35) enlightenment hence the name gnostics as
(14:38) **being the ones of knowledge** well if
(14:41) that's the essential core of it I think
...
- Gnosticism was a sort of "smorgasbord philosophy" (Cf. also Manicheanism, a belief system present around the same time), in that it took bits and pieces of Christianity, but also grabbed and pulled from other philosophies and religions of the ancient world, and then presented itself as above and against Christianity.
  ...
  - Given that it came about after Christ lived and died, many of its texts seek to correct or edit or otherwise change elements of the scriptural accounts as we know them.<!-- slide-break -->
...
### Gnostic fundamentals {#gnostic-fundamentals}
...
(23:58) secret knowledge that **is to be kept to
(24:00) oneself**
...
- There is some variety in the specifics, but as a generalization, these three points are decent in terms of explaining "what makes something gnostic" (=worthy of the label):
  ...
  - 2) Hatred of the material world: that this material world is inherently rotten and corrupted—that sin is fundamentally physical and tied to the physical.
  - 3) Elitist/secret knowledge. They saw no need to evangelize. To them, they saw themselves as having some sort of mystical personal spiritual knowledge that only they could access; something just for them. Cf. modern cults like Scientology that don't try to proselytize, but are content lording their supposedly "secret knowledge" over everyone.<!-- slide-break -->
