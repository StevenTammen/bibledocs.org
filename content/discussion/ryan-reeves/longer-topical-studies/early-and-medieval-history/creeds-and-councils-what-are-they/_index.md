...
title: "Creeds and councils: what are they? (src: Ryan Reeves)"
stags: 
ptags: 
...
{{< discussion-note src="Ryan Reeves" text="Creeds and Councils: What are they?" url="https://www.youtube.com/watch?v=xMz5MiM4iww" >}}

## Video {#video}

- [Link to recording segments on Dropbox](https://www.dropbox.com/scl/fo/f6cu5ubx7ramflboe2872/AOGDrToujLthySq_NI_GNco?rlkey=v8pwzrmvzz9j3cd5h3si98jyi&st=kshkwj9j&dl=0)
...
(0:13) **In this lecture**, we're going to be
(0:14) looking at creeds and councils. What are

End:

(4:44) bent on enforcing sometimes with capital
(4:47) **punishment the decisions of the church**.
(4:50) But in terms of the history of the
...
Creeds and councils: what are they, and what role did they play in the Early Church?

Some common misunderstandings about creeds and councils:

- What was their purpose?
- How did they arise?
- What should our relationship to them be as Protestants and Evangelicals?

One popular misunderstanding about councils: that they really only get going in the 4th century.
...
- The new thing: Constantine calls for a so-called "ecumenical" council, bringing together all the bishops in the Roman world = (hypothetically) the entire Church, in at least representative form
- Constantine also adds a political component that was not there before.
  - Previous pagan Roman authority had little interest in the past councils, so of course under them there was no idea of "enforcement" of decisions. But not so now, under Constantine.
...
As I went over in my [separate introduction to my own personal views on Church Fathers, Councils, and Creeds](), I follow and advocate for a methodology that examines the Church Councils primarily from a historical (rather than a theological) perspective, and do not at all view them as doctrinally dispositive. On account of this, I am none too shy about criticizing how things proceeded when I think circumstances merit such.

And right from the outset, I have two big criticisms, pertaining to the organizational shifts that come about at Nicea. The first is regarding the utility (or rather lack thereof) of ecumenical pronouncements in general, and the second is regarding the politicization of doctrinal disagreement.
...
{{% quote src="https://www.amazon.com/Conference-Carthage-Translated-Texts-Historians/dp/1836243413" text="The Conference of Carthage in 411 (Translated Texts for Historians, 90)" %}}

On the heels of Alaric’s sacking of the city of Rome in 410 CE, Honorius, the emperor of the Roman west, appointed Flavius Marcellinus to oversee and judge a debate between two sparring Christian groups in Africa: the Donatists and Catholics. The debate was held in the wealthy city of Carthage, close to what is now modern-day Tunis. At stake were the future of Christian orthodoxy and even the survival of the Roman west, as Honorius feared that if this century-old sectarian rift were not healed, grain-rich Africa might be vulnerable to rebellion and secession, thereby threatening Italy with starvation and the emperor with annihilation.
...
(4:47) punishment the decisions of the church.
(4:50) **But in terms of the history of the**
(4:52) church meeting together in synodal form

End:

(10:48) out as well as the **ensuing centuries
(10:50) thereafter**.
(10:52) But we can look at just another council
...
People in the Early Church had been meeting together in synodal/council form for quite some time before Nicea in 325.
...
- Bishops/rulers/leaders from churches in a geographical area (e.g., Rome, Asia Minor) would come together to make some decision.
- These "regional" meetings sometimes get overlooked, perhaps because they are often termed "synods" (with a small-S) rather than "capital-C Councils".

It bears repeating that these meetings were not undertaken lightly, in that they mostly only gathered together to deal with crises/controversies/schisms, and not anything less.
...
- Know of a meeting, but not know what was discussed in the meeting.
- Know what was discussed at the meeting, but not know what decision was reached in the meeting.
- Know what decision was reached in the meeting, but not know *how* they reached that decision/what their reasoning was.
- Etc.
...
Let's talk more about the council of Acts 15, and why I don't see it as being good evidence for Church Councils as a general concept.

Firstly, this council was convened by capital-A Apostles, and not just one or two at that, but most of them, as far as we can tell from the text. This point alone makes this council not at all comparable to later synods and councils run by mere pastor-teachers who were not Apostles.
...
At any rate, the letter sent to the Gentile churches dealing with these sorts of practical issues is perfectly unobjectionable in its discussion of daily application, but it is actually sort of an open question how much of this is supposed to be doctrinally binding in any sense. And more to the point, the council did not seem to discuss "enforcement" of this (via some sort of centralized authority structure) whatsoever, as best we can see from the text. They simply wrote a letter answering questions that had arisen, and that was that.
...
(10:50) thereafter.
(10:52) **But we can look at just another council**
(10:53) for example in 193 in the near Asian

End:

(15:19) things like sexual immorality and the
(15:21) **discipline of pastors, etc.** Okay, I'm
(15:24) not going to go through all the synods
...
Another example: in c. 193 AD, a synod was held to discuss the issue of what is known as [Quartodecimanism](https://en.wikipedia.org/wiki/Quartodecimanism).

- Simplifying a bit, the council came together to discuss how "Jewish" the celebration of Easter ought to be. Jewish custom celebrated the Passover on the 14th day (where the quarto- and deci- parts of Quartodecimanism come from) of the month of [Aviv](https://en.wikipedia.org/wiki/Aviv) in the Jewish calendar system, and some people thought the celebration of Easter should match that, meaning it would align with the time of the sacrifice of the Passover lamb.
- But that means that year by year, the day of the week would jump around (i.e., rather than Easter always being on Sunday, one year it might be a Tuesday, another Thursday, etc.).
...
The controversy surrounding Quartodecimanism is an excellent example of another issue I tend to have with Church Councils: sometimes they seek to institutionalize and legislate things that 1) aren't taught in a black and white sort of way in scripture, and/or 2) simply aren't important. As I see things, people would do well to stay spiritually red-hot all year round (rather than putting special focus on lent and advent, for example), but that aside, it *really* doesn't matter what day of the week your particular local congregation decides to have an Easter service. Like, not at all, nada.
...
As I see things, all the shade that got slung about in ancient Church Councils about things of little import is pretty good evidence that the Early Church went off the rails pretty soon after the Apostles left the scene. I'm sure many would not agree with that characterization of things, but if you go look at the subjects that were the primary topics of some of these councils (primary, not secondary), I think you would agree that at best, they were arguing about things of secondary importance, and at worst, they were legalistically making rules about things the Bible doesn't specify in a black and white sort of way. And neither of these characterizations is at all positive.
...
(15:19) things like sexual immorality and the
(15:21) discipline of pastors, etc. **Okay, I'm**
(15:24) not going to go through all the senates

End:

(23:30) And again, it won't all be neat. It
(23:33) won't always be pretty, but it's the
(23:35) **church and we love her**.
...
In any case, through all these examples we can see some patterns emerge in church councils:
...
I think Dr. Reeves is noticeably gentler and more diplomatic in this section than I tend to be when it comes to these matters. I suppose some of this comes down to what sort of emphasis (or "spin") one might wish to put on the discussion. My general approach is to sort of go full-on *sola scriptura* zealot in a take-no-prisoners manner. Put uncharitably, this perhaps at times come off as a bit iconoclastic and arrogant, but as I see things, the key takeaway that does in fact need to be emphasized is that it is the Bible alone that can be used for determining doctrine, not Church Fathers, Councils, or Creeds—not even a teensy tiny bit them.

But that is merely one rhetorical lens through which you might view these matters. If you take a step back and try to analyze these things less from the perspective of their utility (or rather lack thereof) in developing theological positions, then I think you arrive at a presentation style closer to what Dr. Reeves does here—analyzing factual information about the exact nature and character of these Church Fathers, Councils, and Creeds without necessarily making formal judgments in so doing.
...
- Church councils were called willy-nilly at the drop of a hat. (Instead, they were mostly convened sparingly, in response to serious circumstances).
- Church councils made up new things in some sort of generative process. (Instead, they mostly sought to settle on what teaching(s) that already existed ought to be the one(s) accepted as a standard, through consensus).
- Church councils sought to exhaustively define systems of beliefs. (Instead, they mostly sought to put guard rails about what *not* to believe).
- Etc.
