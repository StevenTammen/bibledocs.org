...
title: "Early Church and Trinity: Father and Son (src: Ryan Reeves)"
stags: 
  - Trinity
  - Church history 
ptags: 
...
{{< discussion-note src="Ryan Reeves" text="Early Church and Trinity: Father and Son" url="https://www.youtube.com/watch?v=IlzM7LogGRU" >}}

## Video {#video}

- [Link to recording segments on Dropbox](https://www.dropbox.com/scl/fo/jl3tpgcjothvgh2881ro5/AIlGJIh2b_Rd4d0TDKakyZA?rlkey=f7scbayghnmd34ajtm3atnes5&st=b538jfg5&dl=0)
...
(3:23) father son and spirit in other words
(3:26) **when we look at the discussions of the**
(3:28) trinity in the 4th century particular

End:

(8:53) doesn't mean that we **consign it to the
(8:57) Flames** well if that's our general focus
(8:59) focus when we come to something like
...
Like we discussed in our last video about how Church Councils generally operated, Church Councils (and the Creeds that came out of them) did not really create new doctrines out of thin air, but rather often sought to put forward bounds or guardrails with regard to how certain doctrines were discussed, vocabulary-wise.
...
On the one hand, it is not as if the Bible itself has nothing to say about such topics as:

- The being of Christ
- His claims to Divinity
- The Trinity generally
...
The remaining text in this summary points section (going over the "two affirmations" of scripture and the Church's self-definition of terms) merely goes over what the video clip says, in broad strokes. I personally believe slightly different things (or at least, I definitely emphasize some different things when discussing these concepts), and so we'll talk about what I think in the follow-on topics section immediately following this one.

{{% /note %}}

Dr. Reeves states that there are two things to affirm:

- Scripture
- The Church's self-definition of terms
...
- That the councils are obvious teachings of scripture; that the relationship between the Bible and the Creedal statements is basically an equals sign (ignoring how specialized terminology like *homoousios* came to be developed, e.g.)
  - With the idea being that this is sort of running away from defining or discussing the relationship between what the scriptures say and what we have come to describe them as saying in our theological language.
- That the creeds or confessions are just "works of men", or perhaps more common for Evangelicals, "works of the big bad Catholic Church" (i.e., as opposed to being works having anything to do with us in our theological heritage) = things to be consigned to the flames, more or less.
...
I think I understand some of what Dr. Reeves is arguing against here with regards to his criticism of certain manifestations of the "obvious from scripture" concept. To be honest, often when people say that something is "obvious" in scripture (or "self-evident"), I tend to usually view whatever they say after that as being too simplistic, and even circular in reasoning (at least at times). They'll say "the Bible teaches my position!" when in fact their position is an interpretation of scripture couched in specific technical theological vocabulary that you don't even see in the Bible itself. How then can it be truly self-evident from scripture?
...
So basically, when Dr. Reeves says

> The Church's role is to help us understand our language and shape our vocabulary.
...
To be clear, this doesn't mean there was anything inherently wrong with the impulse to come up with good terms to use and good ways to explain these theological topics, but it does mean that as I see things, Church Councils and Creeds are still completely divorced from interpretation of scripture, epistemologically speaking; they are neither here nor there. If we happen to teach things in-line with the pronouncements of Church Councils and Creeds, well and good; if not, then it still doesn't matter... since sometimes they err. Soon enough you will see an example of me straight up disagreeing with a creedal pronouncement coming out of Nicea: I think "eternally begotten" is a nonsensical concept that does far more harm than good in explaining relationships within the Trinity.
...
(16:11) **driving people to these
(16:13) questions** okay so what is the early
(16:16) vocabulary in the debates about the
...
The way that the Church develops the crises related to Christ really conforms the same pattern of questioning many believers find themselves following in their own lives.

Generally speaking, there are three main steps (with the first two being primary, and more "hot topics" in terms of debate):

1. How does Jesus relate to the Father?
...
(25:48) doesn't square with scripture and so the
(25:50) church **rejects it in the early 2nd
(25:52) Century** now how does this flow into Nicea
...
Modalism (AKA Sabellianism, AKA... many other titles) was one of the earliest heresies regarding the relationship between the Father and the Son (and the Spirit).

Sabellius was one of those credited with popularizing this particular set of views (hence how the concept came to bear his name). He flourished in the early 200s AD.
...
Many "illustrations" of the Trinity tend towards modalism (so in Steven's opinion are subpar and shouldn't be used at all in Bible teaching).
...
- Jesus's high priestly prayer in Gethsemane is... Him talking to Himself?
- Jesus crying out to the Father on the cross is again... Him talking to Himself?
- Or Christ's baptism, where the Father speaks to the Son, and the Spirit descends.
- Etc.
...
I should emphasize that it is the attacking of modalism (while simultaneously trying to articulate a convincing alternate explanation) that almost directly leads to the development of Arianism, which falls into the ditch on the opposite side of the road—by completely separating Jesus from the Father through insisting that He is in fact a completely separate being who is merely united in will with the Father.
...
(25:50) church rejects it in the early 2nd
(25:52) Century **now how does this flow into Nicea**
(25:55) or these other Creeds well simply put

End:

(28:31) Origins and the principal radical origin
(28:35) **is Aras himself**
...
After modalism is rejected by the Church, different positions arise to offer alternate explanations.
...
- Origen essentially applies Platonism to the Trinity and teaches:
  - The Father is Unbegotten—the source
  - The Son is begotten eternally
  - The Spirit flows from the Father
...
Overall, I am much more on board with how the West came to describe things. If one wishes to use the jargon, I do not see any subordination in the Ontological Trinity, only in the Economic Trinity. That is, if God shares one essence, how can there be anything but equality between the three persons in the Trinity, in terms of their being? They may choose to play a subordinate role (as the Son does with respect to the Father), but that is in terms of role, not ontology.
...
# True or False: Church Councils often developed new doctrine. {#true-or-false-church-councils-often-developed-new-doctrine}

1. [ ] True
1. [x] False

# True or False: People did not believe in the doctrine of the Trinity before it was defined by Church Councils. {#true-or-false-people-did-not-believe-in-the-doctrine-of-the-trinity-before-it-was-defined-by-church-councils}

1. [ ] True
1. [x] False

# Which of the following statements about Modalism are true: {#which-of-the-following-statements-about-modalism-are-true}

I. Was popularized and taught by Sabellius 
II. Has many different names
III. Is the concept that the Father and Son are distinct persons
IV. Was one of the earliest heresies regarding the relationship between the Father and the Son

1. [ ] I. and IV. alone
1. [ ] II. and IV. alone
1. [x] I., II. and IV. alone
1. [ ] I., II. and III. alone
1. [ ] All of the above

# What was the reaction to Modalism? {#what-was-the-reaction-to-modalism}

Check all that apply 

1. [ ] The Church widely accepted Modalism
1. [x] Sabellius and his teachings were strongly attacked by Tertullian
1. [x] Alternative teachings arose to refute it, including Arianism 
1. [x] The Church rejected Modalism
1. [ ] Modalism was affirmed by Church Councils

# How should we view Church Councils and Creeds? {#how-should-we-view-church-councils-and-creeds}

Check all that apply

1. [ ] As a key part of our theological heritage
1. [x] As historical events that helped contextualize theological doctrine
1. [x] As meeting largely in response to heresy in the Early Church
1. [ ] As necessary components of our Christian faith
1. [x] As divorced from direct interpretation of scripture
1. [x] As defining theological vocabulary

# Put these questions in their logical progressive order. {#put-these-questions-in-their-logical-progressive-order}

There are three main steps (or questions) that the language of the New Testament invites (often asked in the lives of individual believers), which helps explain the context of the theological developments and controversies addressed by the Councils and Creeds. 

1. How does Jesus relate to the Father?
2. How human is God come down?
3. Is the Holy Spirit a separate person? 

# What alone should determine our theological positions? {#what-alone-should-determine-our-theological-positions}

1. [x] The Bible | Bible

# True or False: Many illustrations of the Trinity tend towards Modalism. {#true-or-false-many-illustrations-of-the-trinity-tend-towards-modalism}
