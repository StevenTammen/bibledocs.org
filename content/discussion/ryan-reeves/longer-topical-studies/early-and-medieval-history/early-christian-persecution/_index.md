...
title: "Early Christian persecution (src: Ryan Reeves)"
stags: 
ptags: 
...
{{< discussion-note src="Ryan Reeves" text="Early Christian Persecution" url="https://www.youtube.com/watch?v=hJR0A9phBc8" >}}

## Video {#video}

- [Link to recording segments on Dropbox](https://www.dropbox.com/scl/fo/vmnrti2qy9k6rlrx0uf50/AFvM0TTTm5ql-V5qx-iB_r0?rlkey=3mn7qsuvlljq9yy21j6efxeij&st=3b2hb16c&dl=0)
...
0:13) **it is sometime between** 155 and 160 AD
(0:16) and we are in the city of Samara which

End:

(3:43) and then **how did the Roman world respond
(3:45) with persecution** and the first thing we
(3:48) have to say is that persecution of
...
(9:15) worst in the **most systemic and
(9:17) widespread persecutions** now before we
(9:20) get into the history of it a little
...
(11:07) trustworthy source that we have to be
(11:09) **careful with it in general** now if we
(11:12) want to talk about Christianity in the
...
(19:31) that way **but for the Christians in the
(19:33) first centuries they will** okay now as we
(19:36) turn to look at the actual persecutions
...
(32:17) like the Apostles not a few of the
(32:20) earliest Christians **paid the ultimate
(32:22) price for following their Lord**
