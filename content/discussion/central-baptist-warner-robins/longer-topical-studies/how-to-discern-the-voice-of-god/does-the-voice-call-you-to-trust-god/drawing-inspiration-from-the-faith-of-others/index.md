...
# True or False: Drawing inspiration from others does not necessarily mean we are comparing ourselves to them. {#true-or-false-drawing-inspiration-from-others-does-not-necessarily-mean-we-are-comparing-ourselves-to-them}
...
# Which of these statements about historical figures are true? {#which-of-these-statements-about-historical-figures-are-true}
...
# True or False: We should not look at other believers as an unattainable standard, but learn from them and reconize that we are all tools in God's hands. {#true-or-false-we-should-not-look-at-other-believers-as-an-unattainable-standard-but-learn-from-them-and-reconize-that-we-are-all-tools-in-god-s-hands}
