...
Eventually: quick note about lack of self-promotion, importance of word-of-mouth, and also link to ways that readers can contribute to this ministry:

- Share ministry, signal boost (but only if you actually find it useful and helpful)
- Participate in online Bible studies, forums, and discord server. Be there for others.
- Helping translate pages from higher level to lower level
- Typo corrections and content improvements via pull requests
- Create timestamps for videos posted on YouTube to organize video content much more effectively
...
<!-- Forums and Discord server after making page about church attendence and community in the digital age -->
...
I run three different online Christian study groups (a Bible study group, a Greek group, and a Hebrew group), record our meetings, and [post the videos on YouTube](https://www.youtube.com/channel/UCFk7khraAKf68DZ5GeYEFIw/playlists).
